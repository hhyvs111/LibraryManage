...
public class Book extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        }else if("bookifQuery_reader".equals(action)){
            return bookifQuery_reader(mapping,form,request,response);
        }
    ...
    private ActionForward bookAdd(ActionMapping mapping, ActionForm form,
           ...
           bookForm.setAvailable(bookForm.getStock());
       ...
       private ActionForward bookifQuery_reader(ActionMapping mapping, ActionForm form,
               HttpServletRequest request,
               HttpServletResponse response){
			String str=null;
			if(request.getParameter("f")!=null){
			...
			request.setAttribute("ifbook",bookDAO.query(str));
			System.out.print("条件查询图书信息时的str:"+str);
			return mapping.findForward("bookifQuery_reader");
		}
        /***********************查询修改图书信息**************************/
