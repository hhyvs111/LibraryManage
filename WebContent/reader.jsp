...
<td width="13%">
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="13%" bgcolor="#1E90FF">读者编号</td>  
    <td width="10%" bgcolor="#1E90FF">姓名</td>
    <td width="8%" bgcolor="#1E90FF">读者类型</td>
    <td width="12%" bgcolor="#1E90FF">证件类型</td>
    <td width="20%" bgcolor="#1E90FF">证件号码</td>
    <td width="12%" bgcolor="#1E90FF">电话</td>
    <td width="15%" bgcolor="#1E90FF">Email</td>
    <td width="5%" bgcolor="#1E90FF">修改</td>
    <td width="5%" bgcolor="#1E90FF">删除</td>
  </tr>
<%
  while(it.hasNext()){
