...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="22" valign="top" class="word_blue">当前位置：系统查询 &gt; 图书档案查询 &gt;&gt;&gt;</td>
      </tr>
      <tr>
        <td align="center" valign="top">
	<form action="" method="post" name="form1">  
 <table width="98%" height="38"  border="0" cellpadding="0" cellspacing="0" bgcolor="#1E90FF" class="tableBorder_gray">
  <tr>
    <td align="center" bgcolor="#1E90FF">

&nbsp;<img src="Images/search.gif" width="45" height="28"></td>
    <td bgcolor="#1E90FF">请选择查询依据：
...
%>
  ...
  <tr align="center" bgcolor="#e3F4F7">
     <td width="15%" bgcolor="#1E90FF">图书编号</td>  
    <td width="25%" bgcolor="#1E90FF">图书名称</td>
    <td width="12%" bgcolor="#1E90FF">作者</td>
    <td width="12%" bgcolor="#1E90FF">图书类型</td>
    <td width="15%" bgcolor="#1E90FF">出版社</td>
    <td width="10%" bgcolor="#1E90FF">书架</td>
    <td width="4%" bgcolor="#1E90FF">馆藏</td>
    <td width="4%" bgcolor="#1E90FF">库存</td>
    </tr>
<%
  while(it.hasNext()){
	...
	available = bookForm.getAvailable();
	%> 
  <tr>
