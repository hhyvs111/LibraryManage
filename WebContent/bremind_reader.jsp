...
<html>
<%
Collection coll=(Collection)request.getAttribute("Bremind_reader");
%>
<head>
<title>图书馆管理系统</title>
...
%>
  ...
  <tr align="center" bgcolor="#e3F4F7">
    ...
    <td width="28%" bgcolor="#1E90FF">图书名称</td>
    <td width="17%" bgcolor="#1E90FF">读者编号</td>
    <td width="9%" bgcolor="#1E90FF">读者名称</td>
    <td width="15%" bgcolor="#1E90FF">借阅时间</td>
    <td width="16%" bgcolor="#1E90FF">应还时间</td>
    </tr>
<%
  while(it.hasNext()){
