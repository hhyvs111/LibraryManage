    ...
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<form name="myform" method="post" action="borrow.do?action=borrowQuery">
          <table width="98%" height="67"  border="0" cellpadding="0" cellspacing="0" bgcolor="#1E90FF" class="tableBorder_gray">
            <tr>
              <td rowspan="2" align="center" bgcolor="#1E90FF">&nbsp;<img src="Images/search.gif" width="45" height="28"></td>
              <td height="29" bgcolor="#1E90FF"><input name="flag" type="checkbox" class="noborder" value="a" checked>
                请选择查询依据：
                <select name="f" class="wenbenkuang" id="f">
                  <option value="barcode">图书编号</option>
                  <option value="bookname">图书名称</option>
                  <option value="readerbarcode">读者编号</option>
            ...
            <tr>
              <td height="26" bgcolor="#1E90FF">
                <input name="flag" type="checkbox" class="noborder" value="b">
                借阅时间：                从
                <input name="sdate" type="text" id="sdate" onfocus="WdatePicker({readOnly:true,maxDate:'%y-%M-%d'})">
                到
                <input name="edate" type="text" id="edate" onfocus="WdatePicker({readOnly:true,maxDate:'%y-%M-%d'})">
                </td>
            </tr>
          </table>		
		</form>
...
%>
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="11%" bgcolor="#1E90FF">图书编号</td>
    <td width="29%" bgcolor="#1E90FF">图书名称</td>
    <td width="12%" bgcolor="#1E90FF">读者编号</td>
    <td width="10%" bgcolor="#1E90FF">读者名称</td>
    <td width="12%" bgcolor="#1E90FF">借阅时间</td>
    <td width="12%" bgcolor="#1E90FF">应还时间</td>
    <td width="10%" bgcolor="#1E90FF">是否归还</td>
  </tr>
<%
  while(it.hasNext()){
