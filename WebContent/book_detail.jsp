...
<%  
	...
	int available = bookForm.getAvailable();
  %>
	<table width="600" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td width="173" height="30" align="center">图书编号：</td>
...
<!--       </tr> -->
      <tr>
        ...
        <td><input name="paperType" type="text" value="<%=publishing%>" size="45"></td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="30" align="center">馆藏：</td>
        <td><input name="stock" type="text" id="stock" value="<%=stock%>"></td>
      </tr>
            <tr>
        <td height="30" align="center">库存：</td>
        <td><input name="available" type="text" id="available" value="<%=available%>"></td>
      </tr>
      <tr>
        <td height="30" align="center">书架：</td>
