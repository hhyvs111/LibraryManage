...
<input name="inputkey" type="text" id="inputkey" size="50">
  ...
  <input name="Button" type="button" class="btn_grey" value="重置" onClick="window.location.href='bookBorrow.jsp'">
                   </td>
               </tr> 
          <tr>
            <td valign="top" bgcolor="#FFFFFF" style="padding:5px"><table width="99%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#1E90FF" bgcolor="#FFFFFF">
