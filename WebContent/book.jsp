...
<td width="13%">
  ...
  <tr align="center" bgcolor="#e3F4F7">
    <td width="5%" bgcolor="#1E90FF">图书编号</td>  
    <td width="18%" bgcolor="#1E90FF">图书名称</td>
    <td width="10%" bgcolor="#1E90FF">图书类型</td>
    <td width="14%" bgcolor="#1E90FF">出版社</td>
    <td width="8%" bgcolor="#1E90FF">书架</td>
    <td width="4%" bgcolor="#1E90FF">馆藏</td>
    <td width="4%" bgcolor="#1E90FF">库存</td>
    <td width="4%" bgcolor="#1E90FF">修改</td>
    <td width="4%" bgcolor="#1E90FF">删除</td>
  </tr>
<%
  while(it.hasNext()){
