...
<td width="16%">
  ...
  <tr align="center" bgcolor="#FFFFFF">
    <td width="26%" bgcolor="#1E90FF">管理员名称</td>
    <td width="12%" bgcolor="#1E90FF">系统设置</td>
    <td width="12%" bgcolor="#1E90FF">读者管理</td>
    <td width="12%" bgcolor="#1E90FF">图书管理</td>
    <td width="11%" bgcolor="#1E90FF">图书借还</td>
    <td width="10%" bgcolor="#1E90FF">系统查询</td>
    <td width="9%" bgcolor="#1E90FF">权限设置</td>
    <td width="8%" bgcolor="#1E90FF">删除</td>
  </tr>
<%
  while(it.hasNext()){
