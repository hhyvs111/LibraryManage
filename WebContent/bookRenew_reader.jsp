...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td align="center" valign="top" style="padding:5px;"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="72" align="center" valign="top" background="Images/main_booksort_1.gif" bgcolor="#1E90FF"><table width="96%" border="0" cellpadding="1" cellspacing="1" bordercolor="#F8BF73">
          <tr>
...
if(readerForm!=null){
	...
	barcode1=readerForm.getBarcode();
...
%>
				...
				<form name="form1" method="post" action="borrow.do?action=bookrenew_reader">
          ...
          <tr>
            <td valign="top"><table width="100%" height="35" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" bgcolor="#FFFFFF">
                <tr align="center" bgcolor="#FFFFFF">
                  ...
                  <td width="12%" bgcolor="#FFFFFF">借阅时间</td>
                  <td width="13%" bgcolor="#FFFFFF">应还时间</td>
                  <td width="14%" bgcolor="#FFFFFF">出版社</td>
                  <td width="12%" bgcolor="#FFFFFF">书架</td>
                  <td bgcolor="#FFFFFF">定价(元)</td>
                  <td width="12%" bgcolor="#FFFFFF"><input name="Button22" type="button" class="btn_grey" value="完成续借" onClick="window.location.href='borrow.do?action=bookrenew_reader'"></td>
                </tr>
<%
int id=0;
String bookname="";
...
%>
                   <tr>
                     ...
                     <td width="12%" align="center"><a href="borrow.do?action=bookrenew_reader&barcode=<%=barcode%>&id=<%=id%>">续借</a>&nbsp;</td>
                   </tr>
                <%	}
}%>
            </table>
