...
String barcode=(String)session.getAttribute("barcode");
//验证用户是否登录
if (barcode==null || "".equals(barcode)){
	System.out.print("读者没有登录");
	response.sendRedirect("login_reader.jsp");
}
%>
  ...
  <tr>
    <td height="118" valign="top" background="Images/top_bg.gif" bgcolor="#EEEEEE"><table width="100%" height="33"  border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="93%" height="79"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="69" align="right" valign="bottom">当前登录用户：<%=barcode%></td>
        </tr>
    </table></td>
  </tr>
</table>
