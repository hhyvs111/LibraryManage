...
//   String translator="";
 ...
 <table width="98%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#F6B83B" bordercolorlight="#FFFFFF">
  <tr align="center" bgcolor="#e3F4F7">
  	<td width="8%" bgcolor="#1E90FF">借阅次数</td>
    <td width="11%" bgcolor="#1E90FF">图书编号</td>
    <td width="17%" bgcolor="#1E90FF">图书名称</td>
    <td width="13%" bgcolor="#1E90FF">图书类型</td>
    <td width="10%" bgcolor="#1E90FF">书架</td>
    <td width="15%" bgcolor="#1E90FF">出版社</td>
    <td width="11%" bgcolor="#1E90FF">作者</td>
    <td colspan="2" bgcolor="#1E90FF">定价(元)</td>
    </tr>
<%
  while(it.hasNext()){
