    ...
    <td height="523" align="center" valign="top"><table width="100%" height="271"  border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td width="2%">&nbsp;</td>
                  <td width="97%" align="center" valign="top">
                    <form name="form1" method="post" action="reader.do?action=readerLogin">
                      ...
                      <td width="10%">读者编号：</td>
                      <td width="31%">
                        <input name="barcode" type="text" class="logininput" id="name" size="27">                        </td>
                      <td width="9%">&nbsp;</td>
                    </tr>
                        <tr>
                          <td height="37">&nbsp;</td>
                      <td>读者密码：</td>
                      <td><input name="paperNO" type="password" class="logininput" id="pwd" size="27"></td>
                      <td>&nbsp;</td>
                    </tr>
                        <tr>
                          <td height="30">&nbsp;</td>
      ...
      <table width="100%" height="27"  border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          密码为身份证后六位<br>管理员请点击<a href=login.jsp>管理员登录</a></td>
        </tr>
      </table></td>
  </tr>
</table></td>
