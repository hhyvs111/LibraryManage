...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td align="center" valign="top" style="padding:5px;"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="72" align="center" valign="top" background="Images/main_booksort_1.gif" bgcolor="#1E90FF"><table width="96%" border="0" cellpadding="1" cellspacing="1" bordercolor="#1E90FF">
          <tr>
...
%>
          ...
          <tr>
            <td valign="top"><table width="100%" height="35" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" bgcolor="#FFFFFF">
                <tr align="center" bgcolor="#e3F4F7">
               	 <td width="12%" height="25" bgcolor="#FFFFFF">图书编号</td>
                  <td width="24%" height="25" bgcolor="#FFFFFF">图书名称</td>
                  <td width="13%" bgcolor="#FFFFFF">借阅时间</td>
                  <td width="13%" bgcolor="#FFFFFF">应还时间</td>
                  <td width="16%" bgcolor="#FFFFFF">出版社</td>
                  <td width="10%" bgcolor="#FFFFFF">书架</td>
                  <td width="8%"bgcolor="#FFFFFF">定价(元)</td>
                  <td width="10%" bgcolor="#FFFFFF"><input name="Button22" type="button" class="btn_grey" value="完成归还" onClick="window.location.href='bookBack.jsp'"></td>
                </tr>
                <%
int id=0;
String bookname="";
...
%>
                <tr>
                  <td height="25" style="padding:5px;">&nbsp;<%=bookBarcode%></td>
                  ...
                  <td width="12%" align="center"><a href="borrow.do?action=bookback&barcode=<%=barcode%>&bookBarcode=<%=bookBarcode%>&id=<%=id%>&operator=<%=manager%>">归还</a>&nbsp;</td>
                </tr>
                <%}
}%>
            </table>
